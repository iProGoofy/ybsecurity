        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="#" className="flex items-center gap-x-3 mb-6">
              ...
              />
              <span className="text-xl font-semibold text-white">YBSecurity</span>
            </Link>
            ...
            {/* Certifications */}
            <div className="mb-6">
              <h4 className="text-sm font-semibold text-white mb-3">Certificeringen</h4>
              <div className="flex items-center gap-4">
                <div className="bg-gray-800 px-3 py-1 rounded-md text-xs font-medium">
                  VPB Gecertificeerd
                </div>
                <div className="bg-gray-800 px-3 py-1 rounded-md text-xs font-medium">
                  ISO 9001
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+31612345678" className="text-gray-400 hover:text-pink-400 transition-colors duration-200">
                  +31 6 12345678
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@ybsecurity.nl" className="text-gray-400 hover:text-pink-400 transition-colors duration-200">
                  info@ybsecurity.nl
                </a>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex items-center gap-4">
                <a href="#facebook" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-pink-700 transition-colors duration-200 group">
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="#linkedin" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-pink-700 transition-colors duration-200 group">
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="#instagram" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-pink-700 transition-colors duration-200 group">
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 py-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto lg:min-w-96">
              ...
              />
              <button className="px-6 py-3 bg-gradient-to-tr from-pink-700 to-orange-800 text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 whitespace-nowrap">
                Aanmelden
              </button>
            </div>
          </div>
        ...
        <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-gray-400">
              <p>&copy; 2024 YBSecurity. Alle rechten voorbehouden.</p>
              <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <Link href="https://pixbyte.nl" target="_blank" className="text-pink-400 hover:text-pink-500 transition-colors duration-200">
                    Pixbyte
                </Link>
            </div>
          </div>
